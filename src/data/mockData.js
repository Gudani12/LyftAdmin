...
export const initialUsers = [
  ...
  { id: 'usr_509', name: 'Lerato Sithole', email: 'lerato.s@example.com', phone: '+27 76 555 0620', idNumber: '9801220800085', role: 'rider', status: 'active', trips: 312, rating: 4.85, paymentState: 'ok', notes: [], deletionRequested: false, emergencyContact: { name: 'Mpho Sithole', relationship: 'Sister', phone: '+27 72 555 0199' } },
  ...
  { id: 'usr_845', name: 'Ryan Govender', email: 'ryan.g@example.com', phone: '+27 79 555 0187', idNumber: '9302170800087', role: 'rider', status: 'active', trips: 88, rating: 4.2, paymentState: 'ok', notes: [], deletionRequested: true, emergencyContact: { name: 'Ayesha Govender', relationship: 'Partner', phone: '+27 82 555 0778' } },
...
export const initialTrips = [
  { id: 'trp_5501', status: 'in_progress', rider: 'Lerato Sithole', driver: 'Nomvula Khumalo', pickup: 'Sandton City, Johannesburg', dropoff: 'OR Tambo Airport', startedAt: daysAgo(0), fare: null, route: [[-26.1076, 28.0567], [-26.1142, 28.0931], [-26.1218, 28.1364], [-26.1295, 28.1842], [-26.1367, 28.2411]] },
  { id: 'trp_5502', status: 'in_progress', rider: 'Ryan Govender', driver: 'Johan van der Merwe', pickup: 'V&A Waterfront, Cape Town', dropoff: 'Claremont', startedAt: daysAgo(0), fare: null, route: [[-33.9036, 18.4201], [-33.9174, 18.4312], [-33.9348, 18.4455], [-33.9573, 18.4568], [-33.9814, 18.4642]] },
